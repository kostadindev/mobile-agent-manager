...
import { Navbar, List, ListItem, Block, Toggle } from 'konsta/react';
import { BookOpen, Lightbulb, Globe, Bot, Search, FileText, Code, Database, Zap, Brain, ChevronRight, type LucideIcon } from 'lucide-react';
